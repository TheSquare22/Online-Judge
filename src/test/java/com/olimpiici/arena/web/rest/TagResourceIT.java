...
class TagResourceIT {
    ...
    public static Tag createEntity(EntityManager em) {
        Tag tag = new Tag().title(DEFAULT_TITLE).keywords(DEFAULT_KEYWORDS).visible(DEFAULT_VISIBLE);
        return tag;
    }
    ...
    public static Tag createUpdatedEntity(EntityManager em) {
        Tag tag = new Tag().title(UPDATED_TITLE).keywords(UPDATED_KEYWORDS).visible(UPDATED_VISIBLE);
        return tag;
    }
    ...
    void createTag() throws Exception {
        ...
        assertThat(testTag.getKeywords()).isEqualTo(DEFAULT_KEYWORDS);
        assertThat(testTag.getVisible()).isEqualTo(DEFAULT_VISIBLE);
    }
    ...
    void putExistingTag() throws Exception {
        ...
        updatedTag.title(UPDATED_TITLE).keywords(UPDATED_KEYWORDS).visible(UPDATED_VISIBLE);
        ...
        assertThat(testTag.getKeywords()).isEqualTo(UPDATED_KEYWORDS);
        assertThat(testTag.getVisible()).isEqualTo(UPDATED_VISIBLE);
    }
    ...
    void partialUpdateTagWithPatch() throws Exception {
        ...
        partialUpdatedTag.title(UPDATED_TITLE).visible(UPDATED_VISIBLE);
    ...
    void fullUpdateTagWithPatch() throws Exception {
        ...
        partialUpdatedTag.title(UPDATED_TITLE).keywords(UPDATED_KEYWORDS).visible(UPDATED_VISIBLE);
