...
describe('Problem Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'problem', component: ProblemComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.problems?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to problemService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getProblemIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getProblemIdentifier).toHaveBeenCalledWith(entity);
