...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../submission.test-samples';

import { SubmissionService, RestSubmission } from './submission.service';
